...
p1 = data %>% mutate(date=lubridate::ymd(release_date)) %>%
  ...
  scale_color_manual(values=c("#32CE7B","#9051A4")) +
  scale_fill_manual(values=c("#32CE7B","#9051A4")) +
  ...
  labs(x="Release date",
       y="Freq (MHz)",
       title="<span style='color:#32CE7B'>CPUs</span> have higher frequencies, but <span style='color:#9051A4'>GPUs</span> are catching up.",
       subtitle="Frequency (in MHz) of CPUs and GPUs released from Jan 01, 2000 to Apr 13, 2021",
       caption="TidyTuesday week 34 | Data source: Summarizing CPU and GPU Design Trends with Product Data")

ggsave("2022_34.png", p1, height=6, width=8, bg="white")
```
