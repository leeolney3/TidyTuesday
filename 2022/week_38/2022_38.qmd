...
ggplot() +
  ...
  labs(title="**2,533** out of **58,502** <span style='color:#70a3ae'><b>waste water treatment plants</b></span> show a dilution factor of less than 10,<br>which represents a common threshold for **environmental concern**",
...
ggsave("2022_38.png", height=7, width=9.7, bg="white")
```
